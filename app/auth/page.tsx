...
export default function AuthPage() {
  ...
  return (
    <main className="grid place-items-center h-screen p-6">
      <div className="w-full max-w-sm space-y-4 bg-white/5 border border-white/10 p-6 rounded-xl">
        ...
        />
        <button onClick={signIn} className="w-full rounded bg-white text-black py-2 font-semibold">Send magic link</button>
