...
// Client-only chart (avoids SSR/hydration crashes)
const ChartSavings = dynamic(() => import('../components/ChartSavings'), {
  ssr: false,
  loading: () => (
    <div className="h-44 rounded-xl bg-slate-900/40 animate-pulse border border-slate-800" />
  ),
})
...
export default function Page() {
  ...
  // Build chart data in a deterministic way; computed after mount
  ...
  return (
    <div className="container space-y-4">
      {/* Row 1: Overview (with client-only chart) */}
      <div className="grid md:grid-cols-3 gap-4">
        <Card className="md:col-span-2">
          <CardHeader>
            <CardTitle>Personal Growth Overview</CardTitle>
          </CardHeader>
      ...
      <div className="grid md:grid-cols-3 gap-4">
        <Card className="md:col-span-2">
          <CardHeader>
            <CardTitle>Finance Planner</CardTitle>
          </CardHeader>
          <CardContent className="space-y-3">
        ...
        <Card>
          <CardHeader>
            <CardTitle>Prayer Snapshot (London)</CardTitle>
          </CardHeader>
      ...
      <div className="grid md:grid-cols-3 gap-4">
        <Card className="md:col-span-2">
          <CardHeader>
            <CardTitle>Study — Cloud Path</CardTitle>
          </CardHeader>
          <CardContent className="space-y-2 text-sm">
...
function Stat({ label, value }: { label: string; value: string }) {
  return (
    <div className="rounded-xl p-3 bg-slate-900/40">
